...
public class BoardDTO {
	...
	public String toString() {
		return String.format(
				"[board_num=%s, board_name=%s, board_pass=%s, board_subject=%s, board_content=%s, board_file=%s, board_re_ref=%s, board_re_lev=%s, board_re_seq=%s, board_readcount=%s, board_date=%s]",
